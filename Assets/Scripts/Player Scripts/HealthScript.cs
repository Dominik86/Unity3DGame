...
public class HealthScript : MonoBehaviour {
	...
	void Awake () {
        //winDialog = GameObject.Find("/UI Canvas/WinDialog");
        //loseDialog = GameObject.Find("/UI Canvas/LoseDialog");
    ...
    void PlayerDied() {
        ...
        if (ScoreScript.scoreValue >= level_up_enemy)
        {
